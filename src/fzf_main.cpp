...
PYBIND11_MODULE(fuzzyfind_functions, m) {
    ...
    m.def("fuzzy_search", [](string query, string root_path, double score_threshold = 35.0, size_t max_buffer_size=50*KB)
            {
            vector<fs::path> path_list = fuzzy_search(query, root_path, score_threshold, max_buffer_size, false);
